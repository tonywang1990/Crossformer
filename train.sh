...
# Train
#python main_crossformer.py --data futs --root_path $ROOT_PATH --train_path $TRAIN --val_path $VAL --num_workers 8 --in_len 2048 --out_len 1 --seg_len 32 --input_dim 24 --output_dim 1 --batch_size 128 --train_epoch 20 --learning_rate 1e-3 --lradj none  #--load_model Crossformer_futs_il1024_ol1_sl32_win2_fa10_dm256_nh4_el3_itr0/checkpoint.pth

# Eval
python main_crossformer.py --data futs --root_path $ROOT_PATH --train_path $TRAIN --val_path $VAL --test_path $TEST --in_len 2048 --out_len 1 --seg_len 32 --input_dim 24 --output_dim 1 --num_workers 8 --batch_size 2048 --train_epoch 20 --learning_rate 1e-3 --lradj none --mode test --save_pred --load_model Crossformer_futs_il2048_ol1_sl32_win2_fa10_dm256_nh4_el3_itr0/checkpoint.pth
